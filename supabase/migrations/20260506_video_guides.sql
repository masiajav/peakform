...
set
  ...
  seo_title = 'Guia de Ana en Overwatch en video - Ivajpro',
  seo_description = 'Aprende Ana en Overwatch con una guia en video de Ivajpro y un resumen rapido sobre posicionamiento, cooldowns y Nano.',
  author = 'Ivajpro',
