...
export const PILLAR_COUNTER_SLUGS = ['shion', 'ana', 'genji', 'kiriko', 'reinhardt', 'dva', 'winston']

export const PILLAR_TEAM_COMP_SLUGS = ['shion', 'ana', 'genji', 'kiriko', 'reinhardt', 'dva']
