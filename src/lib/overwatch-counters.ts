...
const counterMatrix: Record<string, string[]> = {
  ...
  shion: ['winston', 'dva', 'sombra', 'cassidy', 'brigitte', 'kiriko'],
...
function reasonFor(counterSlug: string, targetSlug: string) {
  ...
  const specific: Record<string, string> = {
    ana: `Sleep y granada anti-curación castigan las ventanas de ${target}.`,
    ...
    moira: `Daño fiable, sustain y Fade castigan duelos largos contra ${target}.`,
    brigitte: `Peel, Inspire y Whip Shot frenan entradas y remates de ${target}.`,
    baptiste: `Immortality Field y daño hitscan estabilizan peleas contra ${target}.`,
    ...
    zarya: `Burbujas limpian presión, cargan energía y castigan daño predecible de ${target}.`,
    winston: `Dive directo fuerza cooldowns y expulsa a ${target} de posiciones cómodas.`,
    ...
    sigma: `Barrera y Grasp bloquean ventanas de daño y ultimates de ${target}.`,
    ...
    mauga: `Daño sostenido y presencia frontal obligan a ${target} a ceder espacio.`,
    ...
    reaper: `Daño de corto rango y sustain ganan trades contra ${target} si entra cerca.`,
