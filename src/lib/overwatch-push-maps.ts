...
const pushBasics: Pick<MapPillar, 'attackPlan' | 'defensePlan' | 'vodChecklist'> = {
  ...
  defensePlan: [
    ...
    { title: 'Cuenta las reapariciones', body: 'Avance se rompe con entradas escalonadas. Espera a los cinco cuando haya tiempo y usa el camino central para reagrupar sin regalar otro duelo.' },
...
export const PUSH_MAP_PILLARS: MapPillar[] = [
  {
    ...
    heroPicks: [
      ...
      { name: 'Ana', slug: 'ana', role: 'support', reason: 'Castiga cruces previsibles desde coberturas lejanas.' }, { name: 'Kiriko', slug: 'kiriko', role: 'support', reason: 'Sigue cambios de lado y limpia control en punto de controls.' },
    ],
    compositions: [
  ...
  },
  {
    ...
    mistakes: ['Usar tres atajos distintos en la primera pelea.', 'Entrar en un interior fuera dla coordinación del Tank.', 'Perseguir dentro de edificios mientras TS-1 retrocede.', 'Gastar todas las definitivas en el punto de control.', 'Confundir punto de reaparición avanzado con permiso para entrar solo.'],
    faq: [
  ...
  },
  {
    ...
    quickRead: [
      ...
      { title: 'Las calles favorecen el alcance', body: 'No respondas caminando en línea recta. Avanza por fachadas, fuerza recursos y acelera solo cuando la distancia ya esté cerrada.' },
    ],
    phases: [
  ...
  },
  {
    ...
    seoTitle: 'Runasapi en Overwatch: guía de Avance, rutas y héroes', seoDescription: 'Guía de Runasapi en Overwatch: cómo jugar el centro, las alturas y punto de controls, mejores héroes, composiciones y revisión de VOD.', ...reviewed,
    intro: [
