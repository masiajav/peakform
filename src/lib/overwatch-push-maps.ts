...
const reviewed = { updatedAtIso: '2026-07-04', updatedAt: '4 de julio de 2026' }
...
const pushBasics: Pick<MapPillar, 'attackPlan' | 'defensePlan' | 'vodChecklist'> = {
  attackPlan: [
    ...
    { title: 'Aprovecha el forward spawn', body: 'El checkpoint acorta tus regresos, pero solo si terminas la pelea y evitas muertes tardías que mezclen los respawns.' },
  ...
  defensePlan: [
    ...
    { title: 'Corta la transición', body: 'Después de ganar, busca posición delante del robot sin perseguir hasta el spawn. La siguiente pelea importa más que una baja improbable.' },
    { title: 'Cuenta los respawns', body: 'Push se rompe con entradas escalonadas. Espera a los cinco cuando haya tiempo y usa el camino central para reagrupar sin regalar otro duelo.' },
  ...
  vodChecklist: [
    ...
    '¿Cuántos segundos separaron al primer y al último jugador del regroup?',
    '¿Las muertes tardías regalaron la siguiente esquina?',
    '¿Se aprovechó el forward spawn después del checkpoint?',
...
export const PUSH_MAP_PILLARS: MapPillar[] = [
  {
    slug: 'colosseo', name: 'Colosseo', mode: 'Push', location: 'Roma, Italia', image: '/maps/colosseo.png', imageAlt: 'Calles, puentes y edificios de Colosseo en Overwatch',
    seoTitle: 'Colosseo en Overwatch: guía de Push, rutas y héroes', seoDescription: 'Guía de Colosseo en Overwatch: cómo controlar el centro, los puentes y las curvas, mejores héroes, composiciones y revisión de VOD.', ...reviewed,
    intro: [
    ...
    quickRead: [
      ...
      { title: 'No persigas la curva anterior', body: 'Cuando el rival cede, toma la siguiente esquina. Perseguir hacia su spawn deja al robot parado y rompe tu propia formación.' },
    ],
    phases: [
      { name: 'Centro y primera pelea', attack: 'Acércate por cobertura y reparte al equipo entre dos miradas cercanas. El Tank no necesita abrazar al robot: debe ocupar la esquina desde la que el rival quiere disparar. Fuerza un cooldown, cruza y enfoca un mismo sector. Quien gane puede empujar con una persona mientras el resto bloquea la ruta corta de regreso.', defense: 'Si pierdes un jugador pronto, sal por el lateral y evita morir alrededor del centro. La distancia inicial es pequeña; conservar los respawns vale más que un toque desesperado. Al volver, entra por una ruta común y evita convertir el pasillo en una fila de duelos.', vodReview: 'Mira dónde estaba cada equipo cuando TS-1 se activó. ¿Tu frontline tenía cobertura? ¿Los DPS podían verse entre sí? Después mide cuánto tardó el perdedor en reagruparse de verdad.' },
      { name: 'Puentes y calles largas', attack: 'Toma la esquina antes de que llegue la barricada y desplaza a quien mantiene altura. No hace falta perseguirlo hasta el fondo: obligarlo a abandonar la línea ya permite avanzar. Conserva movilidad para la respuesta rival y deja una ruta visible hacia tus supports.', defense: 'Cobra daño desde distancia y retrocede por el puente sin quedar atrapado. El robot obliga al ataque a avanzar, así que no bajes a campo abierto antes de tiempo. Cuando la barricada gire, cambia de cobertura con el núcleo y evita que un jugador quede defendiendo la calle anterior.', vodReview: 'Pausa en cada cruce de puente. Comprueba si la movilidad sirvió para tomar terreno o solo para llegar antes. Revisa también cuántos metros avanzó el robot mientras todos perseguían.' },
      { name: 'Checkpoint y tramo profundo', attack: 'El checkpoint merece una pelea con recursos, no tres intentos a medias. Espera respawns, fuerza la herramienta que frena tu entrada y usa una combinación sencilla. Tras desbloquear el forward spawn, estabiliza antes de lanzarte al tramo final: una muerte tardía puede anular esa ventaja.', defense: 'Cerca de tu spawn puedes recontestar, pero coordina quién toca y quién dispara desde cobertura. Si recuperas el robot, no persigas demasiado; vuelve a tomar la esquina que obliga al rival a exponerse. Con ventaja de distancia, el tiempo trabaja para ti.', vodReview: 'Separa los contactos del checkpoint. Anota quién tocó, qué recurso lo sostuvo y si había daño detrás. Después comprueba si el forward spawn produjo una pelea completa o una cadena de entradas rápidas.' },
    ],
    ...pushBasics,
    heroPicks: [
      ...
      { name: 'Sojourn', slug: 'sojourn', role: 'dps', reason: 'Aprovecha líneas largas sin renunciar a movilidad.' }, { name: 'Genji', slug: 'genji', role: 'dps', reason: 'Usa pasillos y alturas para cerrar objetivos tocados.' },
      { name: 'Ana', slug: 'ana', role: 'support', reason: 'Castiga cruces previsibles desde coberturas lejanas.' }, { name: 'Kiriko', slug: 'kiriko', role: 'support', reason: 'Sigue cambios de lado y limpia control en checkpoints.' },
    ],
    compositions: [
    ...
    mistakes: ['Pelear encima del robot sin controlar las salidas del centro.', 'Empujar con cinco y regalar la siguiente esquina.', 'Cruzar el puente con movilidad ya gastada.', 'Perseguir hacia spawn después de ganar.', 'Recontestar el checkpoint de uno en uno.'],
    faq: [
      { question: '¿Qué tipo de mapa es Colosseo?', answer: 'Colosseo es un mapa de Push en Roma. Ambos equipos disputan TS-1 y tratan de llevar su barricada más lejos que la rival.' },
      ...
      { question: '¿Qué revisar en una VOD?', answer: 'Revisa posición inicial, control de esquinas, metros convertidos tras victorias, respawns separados y recontests del checkpoint.' },
    ],
  ...
  {
    slug: 'esperanca', name: 'Esperança', mode: 'Push', location: 'Portugal', image: '/maps/esperanca.png', imageAlt: 'Plaza, torre y calles portuguesas de Esperança en Overwatch',
    seoTitle: 'Esperança en Overwatch: guía de Push y rotaciones', seoDescription: 'Guía de Esperança en Overwatch: centro, atajos, checkpoint, mejores héroes, composiciones, errores y checklist para revisar tu VOD.', ...reviewed,
    intro: [
      'Esperança es fácil de leer desde lejos y difícil de ejecutar cuando empieza la pelea. La torre central ayuda a orientarse, pero sus calles peatonales, interiores y atajos permiten que un jugador llegue al lateral mucho antes que el resto. Esa diferencia de pocos segundos decide muchas rondas: el Tank entra, el flanker todavía gira y los supports descubren que la pared portuguesa más bonita del mapa también corta la curación.',
      'Push recompensa a quien piensa una esquina por delante. Tras ganar, una persona acompaña a TS-1 y las demás ocupan puertas, plaza o altura para recibir el siguiente contacto. Esperança ofrece rutas cortas para volver al robot, por lo que perseguir eliminaciones es especialmente tentador. La disciplina consiste en tomar la posición útil y dejar que el rival sea quien tenga que exponerse.',
    ],
    quickRead: [
      ...
      { title: 'El robot cambia de dueño rápido', body: 'Después de una victoria, confirma las bajas antes de perseguir. Un rival vivo puede devolver TS-1 al centro mientras miras hacia su spawn.' },
    ],
    phases: [
      ...
      { name: 'Calles residenciales y atajos', attack: 'Usa los interiores para crear una segunda mirada corta mientras el núcleo avanza por cobertura. El lateral debe aparecer cuando el Tank presione, no antes. Tras ganar espacio, abandona las habitaciones y ocupa la esquina siguiente; el objetivo sigue estando en la calle.', defense: 'Cobra daño desde balcones y puertas con una retirada prevista. Si un atacante entra por dentro, márcalo y ayúdalo desde cerca sin desarmar toda la defensa. Ceder una fachada con vida permite volver a pelear en el siguiente giro.', vodReview: 'En cada muerte interior, revisa si existía línea de ayuda y si la entrada coincidió con el robot. Después mide el progreso perdido por perseguir dentro de edificios.' },
      { name: 'Checkpoint y tramo final', attack: 'Agrupa antes de comprometer ultimates. La calle profunda favorece a la defensa y exige limpiar una esquina antes de que TS-1 llegue. Usa una herramienta para iniciar y guarda otra para el recontest; gastar cinco recursos por el checkpoint suele dejar el avance final sin respuesta.', defense: 'Aprovecha la cercanía del spawn sin entrar solo. El primer jugador toca o ralentiza y el resto prepara daño desde cobertura. Si recuperas el robot con ventaja de distancia, escolta la transición hacia una esquina segura en vez de perseguir hasta el centro rival.', vodReview: 'Anota qué ultimate abrió el checkpoint y cuál quedó para responder. Revisa si los contactos defensivos construyeron una pelea o solo retrasaron los respawns.' },
    ],
    ...pushBasics,
    heroPicks: [
    ...
    mistakes: ['Usar tres atajos distintos en la primera pelea.', 'Entrar en un interior fuera del timing del Tank.', 'Perseguir dentro de edificios mientras TS-1 retrocede.', 'Gastar todas las ultimates en el checkpoint.', 'Confundir forward spawn con permiso para entrar solo.'],
    faq: [
      { question: '¿Qué tipo de mapa es Esperança?', answer: 'Es un mapa de Push ambientado en Portugal. Los equipos disputan el robot y empujan barricadas en direcciones opuestas.' },
      ...
      { question: '¿Qué revisar en una VOD?', answer: 'Revisa tiempos de llegada, sincronización de atajos, líneas de curación, progreso del robot y uso de ultimates en checkpoint.' },
    ],
    relatedLinks: [{ href: '/guides/como-mejorar-en-overwatch-revisando-vod', label: 'Revisar una VOD' }, { href: '/guides/como-revisar-cooldowns-overwatch', label: 'Revisar cooldowns' }, { href: '/heroes/winston', label: 'Guía de Winston' }, { href: '/heroes/kiriko', label: 'Guía de Kiriko' }],
  },
  {
    slug: 'new-queen-street', name: 'New Queen Street', mode: 'Push', location: 'Toronto, Canadá', image: '/maps/new-queen-street.png', imageAlt: 'Calles nevadas, tranvía y edificios de New Queen Street en Overwatch',
    seoTitle: 'New Queen Street: guía de Push, rutas y héroes', seoDescription: 'Guía de New Queen Street en Overwatch: cómo jugar el centro, las calles y el checkpoint, con composiciones y revisión de VOD.', ...reviewed,
    intro: [
      'New Queen Street mezcla calles abiertas con tiendas y pasillos que parecen invitar al flanco perfecto. El problema es que muchos de esos recorridos tardan más que la pelea. Mientras un DPS rodea el bloque, el robot ya ha cambiado de dueño y la frontline retrocede sin saber por qué está jugando cuatro contra cinco. El mapa premia los laterales cortos, visibles y sincronizados.',
      'La nieve no cambia la regla principal de Push: gana espacio delante de TS-1 y convierte cada victoria en distancia. Las calles ofrecen líneas de tiro largas, pero el tranvía, las fachadas y las esquinas cortan visión con rapidez. Cada avance necesita una nueva cobertura para los supports y una salida para quien presiona el lateral. Quedarse pegado al robot simplifica demasiado el trabajo rival.',
    ],
    quickRead: [
      { title: 'El flanco debe llegar a tiempo', body: 'Tiendas e interiores sirven para abrir una segunda mirada cercana. Si la ruta tarda toda la pelea, no era un ángulo: era una ausencia.' },
    ...
    compositions: [
      ...
      { name: 'Dive urbano', lineup: ['Winston', 'Genji', 'Tracer', 'Ana', 'Kiriko'], plan: 'Winston marca un sector junto al tranvía y los DPS convergen. Ana sostiene la calle mientras Kiriko acompaña el segundo movimiento.', weakness: 'Los interiores cortan a Ana y castigan una cadena de engages sin pausa.' },
    ],
    mistakes: ['Tomar un flanco que tarda más que la pelea.', 'Apilarse alrededor del robot en el centro.', 'Cruzar de lado sin comprobar visión de supports.', 'Perseguir por tiendas tras ganar la esquina.', 'Entrar con respawns separados después del forward spawn.'],
    faq: [
      { question: '¿Qué tipo de mapa es New Queen Street?', answer: 'Es un mapa de Push en Toronto donde ambos equipos disputan TS-1 y empujan su propia barricada.' },
      ...
      { question: '¿Qué revisar en una VOD?', answer: 'Revisa duración de flancos, control del tranvía, líneas de curación, conversión de victorias y respawns del checkpoint.' },
    ],
  ...
  {
    slug: 'runasapi', name: 'Runasapi', mode: 'Push', location: 'Perú', image: '/maps/runasapi.png', imageAlt: 'Plaza, arquitectura andina y monumento de Runasapi en Overwatch',
    seoTitle: 'Runasapi en Overwatch: guía de Push, rutas y héroes', seoDescription: 'Guía de Runasapi en Overwatch: cómo jugar el centro, las alturas y checkpoints, mejores héroes, composiciones y revisión de VOD.', ...reviewed,
    intro: [
    ...
    phases: [
      ...
      { name: 'Escaleras, mercado y alturas', attack: 'Adelanta jugadores para tomar plataforma mientras TS-1 sube. Las escaleras comprimen la entrada y hacen valioso forzar control antes de cruzar. Un lateral por mercado debe coincidir con la presión principal y regresar cuando el rival ceda; perseguir dentro pierde el robot.', defense: 'Usa altura para cobrar recursos y baja hacia la siguiente cobertura antes de quedar rodeado. Si el rival divide la entrada, enfoca el sector más comprometido y evita mandar un jugador distinto a cada escalera. Ceder unos metros mantiene la defensa viva.', vodReview: 'Comprueba si la frontline desapareció de la visión al subir y cuánto tardó el lateral en influir. Revisa si la defensa abandonó altura con vida o después de perder la salida.' },
      { name: 'Checkpoint y tramo de spawn', attack: 'Llega con los cinco y una secuencia de ultimates sencilla. El tramo profundo favorece al defensor y castiga a quien usa movilidad solo para tocar. Tras ganar, ocupa la esquina delante de TS-1 y guarda una respuesta para el regreso rápido rival.', defense: 'El spawn cercano permite recontestar con frecuencia, no sin coordinación. Elige un héroe para tocar y coloca daño desde escaleras o puerta. Si tu equipo conserva la ventaja global, ganar tiempo y salir puede ser mejor que perseguir una eliminación.', vodReview: 'Separa cada intento del checkpoint y anota quién podía apoyar el toque. Después revisa si el equipo con ventaja jugó según el reloj o regaló una pelea profunda sin necesidad.' },
    ],
    ...pushBasics,
    heroPicks: [
    ...
    mistakes: ['Pelear abajo mientras el rival conserva plataforma.', 'Acelerar por una escalera sin visión de supports.', 'Confundir una ruta corta con permiso para entrar solo.', 'Perseguir por mercado mientras TS-1 cambia de dueño.', 'Gastar movilidad únicamente para tocar el checkpoint.'],
    faq: [
      { question: '¿Qué tipo de mapa es Runasapi?', answer: 'Runasapi es un mapa de Push ambientado en Perú. Los equipos luchan por TS-1 y por llevar su barricada más lejos.' },
      ...
      { question: '¿Qué revisar en una VOD?', answer: 'Revisa control de altura, líneas al subir, timing de laterales, muertes tardías y apoyo de los recontests.' },
    ],
    relatedLinks: [{ href: '/guides/como-mejorar-en-overwatch-revisando-vod', label: 'Revisar una VOD' }, { href: '/guides/como-revisar-cooldowns-overwatch', label: 'Revisar cooldowns' }, { href: '/heroes/dva', label: 'Guía de D.Va' }, { href: '/heroes/genji', label: 'Guía de Genji' }],
  },
]
