...
export const HERO_PILLARS: Record<string, HeroPillar> = {
  ana: {
    ...
    seoTitle: 'Guía de Ana en Overwatch: posicionamiento, counters y consejos',
  ...
  kiriko: {
    ...
    roleSlug: 'support',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Guía de Kiriko en Overwatch: Suzu, counters y consejos ranked',
  ...
  reinhardt: {
    ...
    roleSlug: 'tank',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Guía de Reinhardt en Overwatch: brawl, counters y ranked',
  ...
  dva: {
    ...
    roleSlug: 'tank',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Guía de D.Va en Overwatch: Matrix, counters y ranked',
  ...
  winston: {
    ...
    roleSlug: 'tank',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Guía de Winston en Overwatch: dive, burbuja y counters',
  ...
  cassidy: {
    ...
    roleSlug: 'dps',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Guía de Cassidy en Overwatch: duelos, counters y ranked',
