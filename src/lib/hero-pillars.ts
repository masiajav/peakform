...
export const HERO_PILLARS: Record<string, HeroPillar> = {
  ana: {
    ...
    seoTitle: 'Ana en Overwatch: posicionamiento, anti-nade, Nano y counters',
    seoDescription: 'Aprende a jugar Ana en ranked: posiciones seguras, Sleep Dart, Biotic Grenade, Nano Boost, counters de dive y errores que hacen que mueras primero.',
  ...
  kiriko: {
    ...
    roleSlug: 'support',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Kiriko en Overwatch: cuándo usar Suzu, kunais, teleport y counters',
    seoDescription: 'Guía de Kiriko para ranked: cuándo curar, cuándo buscar kunais, cómo guardar Suzu, usar Swift Step sin morir y responder a sus counters.',
  ...
  reinhardt: {
    ...
    roleSlug: 'tank',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Reinhardt en Overwatch: cómo crear espacio, usar escudo y ganar brawl',
    seoDescription: 'Guía de Reinhardt para ranked: esquinas, escudo, Charge, Fire Strike, Earthshatter, counters de poke y errores que regalan espacio.',
  ...
  dva: {
    ...
    roleSlug: 'tank',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'D.Va en Overwatch: Matrix, peel, high ground y counters',
    seoDescription: 'Cómo jugar D.Va en ranked: usar Defense Matrix con intención, contestar high ground, hacer peel, evitar beams y sacar valor de Self-Destruct.',
  ...
  winston: {
    ...
    roleSlug: 'tank',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Winston en Overwatch: dive, burbuja, Primal Rage y counters',
    seoDescription: 'Guía de Winston para ranked: cuándo saltar, cómo aislar targets con burbuja, salir vivo del dive, usar Primal Rage y evitar counters.',
  ...
  cassidy: {
    ...
    roleSlug: 'dps',
    updatedAt: '26 de junio de 2026',
    seoTitle: 'Cassidy en Overwatch: duelos, ángulos, anti-flanker y Deadeye',
    seoDescription: 'Cómo jugar Cassidy en ranked: daño útil, ángulos de rango medio, Combat Roll, Deadeye, control de flankers y counters que debes respetar.',
  ...
  tracer: {
    ...
    seoTitle: 'Tracer en Overwatch: blinks, Pulse Bomb, counters y ranked',
    seoDescription: 'Cómo jugar Tracer en ranked: rutas de flank, gestión de blinks, Recall, target focus, counters y señales claras para revisar tus VODs.',
    h1: 'Tracer en Overwatch: cómo jugar flank sin regalarte',
    kicker: 'DPS flanker de timing, presión lateral y limpieza',
    intro: [
      'Tracer no gana por estar todo el rato detrás del rival haciendo ruido. Gana cuando entra en el momento justo, obliga a la backline a mirar atrás y fuerza cooldowns que tu equipo puede castigar.',
      'Tener tres blinks no significa tener permiso para entrar siempre. Si gastas movilidad antes de saber dónde está el peligro, Recall deja de ser una herramienta de outplay y pasa a ser un botón de pánico.',
      'La idea en ranked es simple: elige rutas con salida, entra cuando tu equipo ya está presionando, mira targets que de verdad puedas castigar y no persigas una kill si eso te deja sin blinks ni Recall.',
    ],
    facts: [
      { title: 'Rol', body: 'DPS' },
      { title: 'Subrol', body: 'Flanker, duelista y presión lateral.' },
      { title: 'Punto fuerte', body: 'Forzar atención y cooldowns sin regalarte.' },
      { title: 'Punto débil', body: 'Muere rápido si entra sin blinks, sin Recall o sin información.' },
      { title: 'Ideal en', body: 'Mapas con rutas laterales, health packs y peleas partidas.' },
      { title: 'Sufre contra', body: 'Peel constante, turrets, slows, burst fiable y supports que juegan juntos.' },
    ],
    rankedPlan: [
      'Antes de entrar, mira quién está ocupado con tu equipo. Tracer brilla cuando el rival ya tiene presión frontal y girarse hacia ti le cuesta algo.',
      'Usa los blinks para mantener un ángulo incómodo, no solo para llegar antes. Si gastas dos blinks antes de disparar, tu salida queda muy justa.',
      'Elige targets con criterio: supports aislados, DPS sin movilidad, enemigos tocados o alguien que acaba de gastar su defensivo.',
      'Recall debería cerrar una jugada buena o resetearte después de forzar algo. Si lo pulsas nada más entrar, casi siempre entraste demasiado pronto.',
      'Pulse Bomb no tiene que ser una jugada de clip. Una stick sobre support, un tank sin defensivos o un objetivo forzado ya puede ganar la pelea.',
    ],
    sections: [
      {
        title: 'Timing antes que velocidad',
        body: 'La mayoría de Tracers en ranked entran demasiado pronto. Espera a que tu tank toque espacio, que el rival mire al frente o que un support gaste recurso. Entrar medio segundo tarde suele ser mejor que morir dos segundos antes de tiempo.',
      },
      {
        title: 'Rutas y health packs',
        body: 'Un buen flank tiene health pack, cobertura y salida. Si tu ruta solo funciona ganando el duelo perfecto, no es una ruta: es una apuesta.',
      },
      {
        title: 'Presión sin morir',
        body: 'A veces tu valor no es matar, sino obligar a Ana a mirar atrás, forzar Suzu o sacar a un DPS de su ángulo. Si sobrevives y vuelves a entrar, la presión se acumula.',
      },
    ],
    abilities: [
      {
        title: 'Pulse Pistols',
        body: 'Daño de corto alcance. Acércate con cobertura y dispara cuando puedas trackear de verdad; desde lejos casi siempre solo avisas de que estás llegando.',
      },
      {
        title: 'Blink',
        body: 'Es entrada, microposicionamiento y salida. No gastes todos los blinks para perseguir una baja si después no puedes volver.',
      },
      {
        title: 'Recall',
        body: 'Tu seguro de vida y de tempo. Úsalo después de forzar recursos o ganar un duelo, no como excusa para entrar sin plan.',
      },
      {
        title: 'Pulse Bomb',
        body: 'Sirve para abrir pelea, castigar targets sin movilidad o forzar defensivos. No esperes siempre una triple kill: una baja limpia ya es muchísimo valor.',
      },
    ],
    mistakes: [
      'Entrar antes de que tu equipo presione.',
      'Gastar dos o tres blinks solo para llegar al target.',
      'Usar Recall por ansiedad sin haber forzado nada.',
      'Perseguir una kill hasta perder ruta de salida.',
      'Ignorar turrets, slows o peel rival.',
      'Jugar siempre la misma ruta lateral.',
      'Medir impacto solo por kills y no por recursos forzados.',
    ],
    counters: [
      { title: 'Brigitte', body: 'Hace que la backline sea mucho más difícil de divear y castiga entradas predecibles.' },
      { title: 'Torbjörn', body: 'La torreta corta rutas, revela presión y obliga a Tracer a gastar tiempo limpiando antes de entrar.' },
      { title: 'Symmetra', body: 'Sus torretas y beam castigan peleas en espacios estrechos donde Tracer no puede kitear cómoda.' },
      { title: 'Cassidy', body: 'Si juega cerca de sus supports, amenaza burst fiable y castiga blinks lineales.' },
      { title: 'Winston', body: 'Puede ocupar rutas, forzar Recall y cortar espacio si Tracer entra sin apoyo.' },
      { title: 'Moira', body: 'Fade y sustain hacen que muchos duelos largos no merezcan la pena.' },
    ],
    counterplay: [
      'No pelees dentro de zonas con torretas sin limpiarlas antes.',
      'Contra Brigitte, busca al otro support o fuerza recursos antes de comprometerte.',
      'Contra Cassidy, evita blinkear en línea recta y entra cuando ya gastó recursos.',
      'Si Moira tiene Fade, no conviertas el duelo en una persecución eterna.',
      'Cuando el rival juega muy junto, juega más a forzar atención que a buscar una solo-kill inmediata.',
    ],
    compositions: [
      { title: 'Dive clásico', body: 'Winston o D.Va con Tracer, Genji, Sombra o Echo. Tracer entra cuando el tank ya ha cortado espacio o ha obligado al rival a mirar al frente.' },
      { title: 'Poke con presión lateral', body: 'Sigma o poke de rango con Tracer molestando backline. Funciona si esperas a que el poke fuerce recursos antes de meterte sola.' },
      { title: 'Doble amenaza lateral', body: 'Tracer con Sombra o Genji puede partir la atención de los supports, pero solo si no entráis cada uno a un timing distinto.' },
    ],
    vodReview: [
      'Revisa tus primeras muertes: ¿entraste antes de tu equipo o sin blinks suficientes?',
      'Marca cada Recall: ¿habías forzado un recurso o solo salvaste una mala entrada?',
      'Cuenta cuántas veces cambiaste de ruta cuando el rival empezó a esperarte.',
      'Mira tus Pulse Bomb: ¿buscaban una win condition real o solo una jugada bonita?',
      'Comprueba si tus flancos tenían health pack y salida.',
    ],
    checklist: [
      'Entro cuando mi equipo ya presiona.',
      'Tengo al menos una salida clara.',
      'No gasto todos los blinks para llegar.',
      'Recall no es mi plan principal.',
      'Cambio ruta si me están esperando.',
      'Pulse Bomb busca una baja o recurso concreto.',
    ],
    faqs: [
      { question: '¿Tracer es buena para ranked?', answer: 'Sí, pero exige timing. Si entras con tu equipo y fuerzas recursos sin morir, Tracer puede ganar peleas aunque no consigas una kill en cada engage.' },
      { question: '¿Cuál es el error más común con Tracer?', answer: 'Entrar demasiado pronto y gastar blinks solo para acercarte. Sin blinks ni Recall, cualquier peel rival te puede castigar.' },
      { question: '¿A quién debería atacar con Tracer?', answer: 'Targets aislados, supports sin cooldowns, DPS tocados o enemigos que ya están ocupados mirando a tu frontline.' },
      { question: '¿Cuándo cambio de Tracer?', answer: 'Si el mapa no te da rutas, el rival juega muy junto y cada entrada fuerza Recall sin valor, puede tocar cambiar o jugar más lento.' },
      { question: '¿Pulse Bomb debe matar siempre?', answer: 'No. Si fuerza Suzu, Lamp, Beat o separa una pelea, ya puede generar valor. Una kill limpia es suficiente.' },
    ],
    links: [
      { href: '/counters/tracer', label: 'Counters de Tracer' },
      { href: '/team-comps/tracer', label: 'Composiciones con Tracer' },
      { href: '/roles/dps', label: 'Guías de DPS' },
      { href: '/heroes/genji', label: 'Genji' },
      { href: '/heroes/cassidy', label: 'Cassidy' },
      { href: '/heroes/winston', label: 'Winston' },
      { href: '/guides/como-mejorar-como-dps-overwatch', label: 'Cómo mejorar como DPS' },
  ...
  doctrine: {
    ...
    seoTitle: 'Doctrine en Overwatch: habilidades, perks y cómo jugarlo',
    seoDescription: 'Guía de Doctrine en Overwatch: Cetro eterno, Imbuir, Impulso velado, Drones vigorizantes, Liberación, perks y primeras claves para jugarlo.',
    h1: 'Doctrine en Overwatch: guía del nuevo Support',
    kicker: 'Support ofensivo que cura, potencia aliados y castiga desde media distancia',
    intro: [
      ...
      'El hero trial ya está disponible desde el 12 de septiembre y por fin permite ver su kit completo. Cetro eterno cura o hace daño con el mismo disparo, mientras que Imbuir potencia la siguiente acción de Doctrine y cambia la forma de usar tanto su arma como sus habilidades.',
      'No es un Support de curación automática. Doctrine tiene movilidad, buffs para sus aliados y una definitiva capaz de reducir la salud máxima del rival. La dificultad está en elegir bien a quién apuntar y cuándo gastar Imbuir, porque una misma herramienta puede servir para sostener al equipo, escapar o buscar una jugada agresiva.',
    ],
    facts: [
      { title: 'Rol', body: 'Support.' },
      ...
      { title: 'Identidad', body: 'Support ofensivo de alcance medio que alterna curación, daño y buffs.' },
      { title: 'Recurso clave', body: 'Imbuir potencia el siguiente disparo o habilidad y cambia el efecto que ofrece.' },
      { title: 'Definitiva', body: 'Liberación reduce la salud máxima de los enemigos y concede exceso de salud a los aliados.' },
    ],
    rankedPlan: [
      'Empieza por acostumbrarte al alcance de Cetro eterno. Antes de buscar kills, comprueba desde qué distancia puedes curar con regularidad y cambiar el aim hacia un enemigo sin perder de vista a tu equipo.',
      ...
      'Usa Drones vigorizantes sobre el aliado que realmente puede aprovechar la velocidad de ataque. Con Imbuir también te afectan a ti, así que esa versión encaja mejor cuando necesitas sostenerte mientras acompañas una entrada.',
      'No gastes Impulso velado solo para llegar antes. Su reducción de daño puede salvarte de un dive y, con Imbuir, se convierte en vuelo libre para cambiar de altura o escapar de una zona cerrada.',
    ...
    sections: [
      {
        ...
        body: 'Doctrine está pensado para jugadores cómodos cambiando el crosshair entre aliados y rivales. Cetro eterno usa la misma puntería para curar o hacer daño, de modo que una buena posición debe ofrecer las dos líneas de visión sin obligarte a exponerte de más.',
      },
      {
        title: 'Imbuir decide el siguiente movimiento',
        body: 'Imbuir no hace el trabajo por sí solo: mejora la siguiente habilidad. Puede convertir Cetro eterno en un disparo perforador mayor, permitir que Impulso velado vuele libremente o hacer que los Drones vigorizantes también beneficien a Doctrine. Gastarlo bien importa más que usarlo en cuanto vuelve.',
      },
      {
    ...
    abilities: [
      {
        title: 'Cetro eterno',
        body: 'Arma de alcance medio que cura a los aliados e inflige daño a los enemigos. Cuando está potenciada por Imbuir, lanza un disparo perforador de mayor tamaño, útil para atravesar una pelea y alcanzar varios objetivos alineados.',
      },
      {
        title: 'Imbuir',
        body: 'Añade un efecto más potente a la siguiente habilidad de Doctrine. Conviene decidir qué versión necesitas antes de pulsarlo: mejorar el disparo, ganar vuelo con la movilidad o recibir también el efecto de los drones.',
      },
      {
        title: 'Impulso velado',
        body: 'Desplazamiento horizontal durante el que Doctrine recibe menos daño. Con Imbuir deja de estar limitado al plano horizontal y permite volar libremente, lo que abre rutas hacia high ground y salidas mucho más difíciles de seguir.',
      },
      {
        title: 'Drones vigorizantes',
        body: 'Envía drones hacia un aliado para curarlo y aumentar su velocidad de ataque. Al usar la versión imbuida, Doctrine también recibe sus efectos, una opción valiosa cuando quiere acompañar el engage o necesita recuperarse bajo presión.',
      },
      {
        title: 'Liberación',
        body: 'La definitiva lanza un enjambre de drones que reduce la salud máxima de los enemigos afectados y concede exceso de salud a los aliados. Puede inclinar una pelea larga, pero necesita un equipo preparado para avanzar mientras dura la ventaja.',
      },
      {
        title: 'Superviviente',
        body: 'Su pasiva de subrol activa la regeneración de salud pasiva al usar habilidades de movimiento. Impulso velado sirve así tanto para reposicionarse como para empezar a recuperarse antes.',
      },
    ],
    perks: [
      {
        title: 'Minor · Salvación',
        body: 'Al aplicar Drones vigorizantes, el objetivo recupera 40 de salud de inmediato. Es una pequeña respuesta de emergencia antes de que continúe el efecto de la habilidad.',
      },
      {
        title: 'Minor · Succión sanguinaria',
        body: 'Doctrine se cura un 50% del daño que inflige con el disparo imbuido de Cetro eterno. Premia encontrar un tiro ofensivo cuando necesitas recuperar vida sin abandonar la pelea.',
      },
      {
        title: 'Major · Transfusión',
        body: 'El daño y la curación realizados reducen el cooldown de Imbuir. Cuanto más constante sea tu aportación, antes podrás volver a potenciar una habilidad.',
      },
      {
        title: 'Major · El precio de la vida',
        body: 'Sacrifica 25 de salud máxima a cambio de aumentar un 20% la curación de Cetro eterno. Mejora el sustain del equipo, pero hace que Doctrine sea más vulnerable al burst y exige jugar mejor la cobertura.',
      },
    ],
    mistakes: [
    ...
    faqs: [
      ...
      { question: '¿Qué habilidades tiene Doctrine?', answer: 'Doctrine utiliza Cetro eterno, Imbuir, Impulso velado y Drones vigorizantes. Su definitiva es Liberación y su pasiva de subrol, Superviviente, activa la regeneración al usar una habilidad de movimiento.' },
      { question: '¿Qué hace Imbuir con Doctrine?', answer: 'Imbuir potencia la siguiente habilidad: agranda y vuelve perforador el disparo de Cetro eterno, permite volar con Impulso velado o hace que los Drones vigorizantes también afecten a Doctrine.' },
      { question: '¿Qué perks tiene Doctrine?', answer: 'Sus perks menores son Salvación y Succión sanguinaria. Los mayores son Transfusión y El precio de la vida. Mejoran la curación inicial de los drones, el sustain propio, la frecuencia de Imbuir o la curación del arma.' },
  ...
  dmon: {
    ...
    facts: [
      { title: 'Rol', body: 'Tank' },
      { title: 'Fecha', body: 'Disponible el 11 de agosto de 2026 con la nueva temporada.' },
      ...
      { title: 'Subrol', body: 'Stalwart: más resistencia a knockback y slows que encaja con una frontline de sword + shield.' },
      { title: 'Punto fuerte esperado', body: 'Presencia frontal, amenaza en corto y movilidad horizontal para elegir cuándo entrar.' },
      { title: 'Counter natural', body: 'Verticalidad, rangos largos y ángulos que la obligan a pelear fuera de su zona cómoda.' },
      { title: 'Estado', body: 'Gameplay y kit presentados; faltan números finales, cooldowns y prueba real en ranked.' },
    ],
    rankedPlan: [
      ...
      'Mira la verticalidad desde el lobby. Si Echo, Pharah, Widowmaker o un DPS en high ground juegan gratis, D.Mon puede acabar mirando hacia arriba en vez de marcar el tempo de la frontline.',
    ...
    sections: [
      {
        ...
        body: 'Comparten MEKA y la fantasía de piloto con mech, pero la idea de juego es distinta. D.Va vive mucho de Matrix, high ground, peel y dive. D.Mon apunta más a sword + shield: ocupar espacio de cara, moverse en horizontal y obligar al rival a respetar el brawl.',
      },
      {
      ...
      },
      {
        ...
        body: 'D.Mon llega en un momento donde Busan, MEKA y Talon vuelven al centro del lore. Eso la convierte en una página fuerte para seguir temporada, mapas y composiciones, no solo una ficha de habilidades.',
      },
      {
      ...
      {
        title: 'La verticalidad será el examen',
        body: 'La propia lectura de diseño apunta a que no quiere volar como D.Va. Tiene movimiento horizontal fuerte, pero si el rival vive en high ground o juega desde el cielo, tendrás que cerrar rutas con el equipo en vez de perseguir sola.',
      },
    ],
    abilities: [
      {
      ...
      {
        title: 'Propulsors',
        body: 'Consume combustible para impulsarse en cualquier dirección horizontal. No es vuelo libre: es una herramienta para entrar, corregir ángulo, flanquear corto o salir antes de que el rival te cierre.',
      },
      {
      ...
      {
        title: 'Subrol Stalwart',
        body: 'El subrol Stalwart le da resistencia extra a knockback y slows. Esto refuerza la idea de Tank que quiere aguantar en la frontline y no perder el engage por el primer boop o ralentización.',
      },
      {
    ...
    mistakes: [
      ...
      'Usar Propulsors como si fuera vuelo vertical y perseguir objetivos en zonas donde D.Mon no manda.',
    ...
    counters: [
      ...
      { title: 'Pharah y Echo', body: 'La verticalidad obliga a D.Mon a mirar zonas donde su espada, barrera y movilidad horizontal pierden valor. Si vuelan gratis, su frontline se vuelve mucho menos cómoda.' },
    ...
    counterplay: [
      ...
      'Si el rival juega vertical, no lo resuelvas sola. Pide hitscan, ocupa rutas interiores o fuerza objetivo mientras tu equipo controla el cielo.',
    ...
    compositions: [
      ...
      { title: 'Doble MEKA en 6v6', body: 'D.Mon y D.Va podrían repartir tareas: D.Mon marca frontline y D.Va contesta high ground o peel. La clave será no gastar ambos mechs en el mismo timing.' },
    ...
    vodReview: [
      ...
      'Revisa cuántas veces perdiste valor por mirar verticalidad. Si Echo o Pharah te obligan a abandonar la frontline, no es un problema de aim: es de plan.',
    ...
    checklist: [
      ...
      'Tengo respuesta de equipo si el rival juega high ground o flyers.',
      'No fuerzo brawl si el mapa me deja vendido.',
      'Mi equipo puede seguir el espacio que creo.',
      'Reviso números y cooldowns cuando lleguen los valores finales.',
    ],
    faqs: [
      ...
      { question: '¿Cuál puede ser el counter más claro de D.Mon?', answer: 'La verticalidad pinta como una respuesta natural: Echo, Pharah, high grounds y rangos largos pueden obligarla a pelear donde su espada y barrera aportan menos.' },
    ...
    links: [
      ...
      { href: '/guides/como-mejorar-como-tank-overwatch', label: 'Guía para mejorar como Tank en Overwatch' },
  ...
  zarya: {
    ...
    roleSlug: 'tank',
    updatedAt: '28 de julio de 2026',
    seoTitle: 'Zarya en Overwatch: burbujas, energía, Grav y counters',
    seoDescription: 'Cómo jugar Zarya en ranked: usar burbujas con intención, cargar energía sin feed, proteger engages, jugar Grav y responder a sus counters.',
    h1: 'Zarya en Overwatch: cómo jugar burbujas y energía',
    kicker: 'Tank de brawl, peel puntual y castigo a daño predecible',
    intro: [
      'Zarya parece simple porque dispara un beam y pone burbujas, pero su valor real está en el timing. Una buena burbuja niega burst, salva un engage y te da energía; una mala burbuja solo regala unos segundos sin presión real.',
      'En ranked mucha gente intenta cargar energía por orgullo y termina gastando recursos antes de que empiece la pelea importante. Zarya no necesita estar a 100 todo el tiempo: necesita tener burbujas listas cuando su equipo entra o cuando el rival intenta castigar.',
      'Esta guía se centra en cómo jugar Zarya sin autopilot: cuándo usar burbujas, cómo pelear esquinas, qué targets mirar, cuándo lanzar Graviton Surge y qué revisar en una VOD para saber si tu energía venía de buenas decisiones o de feed caro.',
    ],
    facts: [
      { title: 'Rol', body: 'Tank' },
      { title: 'Estilo', body: 'Brawl, protección puntual y presión sostenida.' },
      { title: 'Punto fuerte', body: 'Castigar daño predecible y salvar engages con burbujas.' },
      { title: 'Punto débil', body: 'Sufre contra rango, verticalidad y equipos que no le cargan energía gratis.' },
      { title: 'Ideal en', body: 'Mapas cerrados, peleas de esquina y comps que quieren avanzar juntas.' },
      { title: 'Sufre contra', body: 'Poke largo, high ground, movilidad vertical y kiteo disciplinado.' },
    ],
    rankedPlan: [
      'Empieza las peleas cerca de cobertura. Zarya sin esquina depende demasiado de recibir curas y termina gastando burbujas defensivas.',
      'Usa la primera burbuja para negar una amenaza concreta, no para ver si alguien te dispara. Si nadie pica, has perdido tempo.',
      'Protege a quien está entrando o siendo castigado. Una burbuja a Genji, Tracer, Reaper o Reinhardt puede convertir un engage dudoso en pelea ganable.',
      'Cuando tengas energía, no corras hacia delante sin recursos. Presiona con beam, corta espacio y guarda una burbuja para sobrevivir al focus.',
      'Graviton Surge necesita follow-up. Antes de tirarla, revisa si tu equipo puede disparar y qué defensivos rivales siguen disponibles.',
    ],
    sections: [
      {
        title: 'Burbujas con intención',
        body: 'La pregunta no es “¿puedo cargar energía?”, sino “¿qué recurso estoy negando?”. Si burbujeas daño sin amenaza real, el rival simplemente espera y te pelea después.',
      },
      {
        title: 'Energía útil, no energía de ego',
        body: 'Ir a 80 de energía no sirve si llegas sin vida, sin burbujas y fuera de cobertura. La energía buena llega mientras mantienes posición y recursos para la pelea real.',
      },
      {
        title: 'Pelear esquinas',
        body: 'Zarya quiere distancias medias-cortas y rutas donde el rival tenga que respetar el beam. En espacios abiertos, el poke te fuerza antes de que puedas convertir energía en presión.',
      },
    ],
    abilities: [
      {
        title: 'Particle Cannon',
        body: 'El beam castiga objetivos que no pueden kitear y no se bloquea con muchas defensas habituales. El disparo secundario ayuda a poke, confirmar targets o tocar grupos.',
      },
      {
        title: 'Particle Barrier',
        body: 'Burbuja propia para negar burst, limpiar presión y cargar energía. Úsala cuando el rival ya se ha comprometido, no solo al caminar por main.',
      },
      {
        title: 'Projected Barrier',
        body: 'Burbuja a aliados. Es una herramienta enorme para habilitar engages, salvar supports o castigar al rival cuando intenta cerrar una kill.',
      },
      {
        title: 'Graviton Surge',
        body: 'Ultimate de control. Gana peleas cuando hay daño, follow-up y defensivos rivales contados; pierde valor si la tiras contra Suzu, Lamp, Matrix o sin equipo cerca.',
      },
    ],
    mistakes: [
      'Gastar burbujas antes de que el rival se comprometa.',
      'Caminar por campo abierto intentando cargar energía.',
      'Pelear sin cobertura porque vas alta de energía.',
      'No burbujear al aliado que está creando la ventaja.',
      'Tirar Graviton sin follow-up.',
      'Ignorar high ground y poke largo.',
      'Perseguir kills cuando ya no tienes burbujas.',
    ],
    counters: [
      { title: 'D.Va', body: 'Puede contestar high ground, negar follow-up de Graviton con Matrix y presionar ángulos que Zarya no alcanza fácil.' },
      { title: 'Widowmaker', body: 'Amenaza desde líneas largas donde Zarya no puede tocarla y obliga a jugar más cerrado.' },
      { title: 'Hanzo', body: 'Burst, spam y Sonic Arrow castigan rutas previsibles antes de que Zarya llegue a rango cómodo.' },
      { title: 'Pharah y Echo', body: 'La verticalidad fuerza a Zarya a depender más de su equipo y reduce el valor de su beam.' },
      { title: 'Zenyatta', body: 'Discord Orb convierte cada cruce abierto en una amenaza seria incluso con energía alta.' },
      { title: 'Mei', body: 'Puede separar a Zarya o cortar a sus aliados, obligando a gastar burbujas defensivas.' },
    ],
    counterplay: [
      'No gastes burbujas solo para cargar si el rival puede esperar.',
      'Contra poke, rota por cobertura y fuerza peleas más cortas.',
      'Contra flyers, juega con hitscans aliados o cambia si nadie puede mirar arriba.',
      'Guarda burbuja para el aliado que va a recibir focus, no para el primero que pierda 50 de vida.',
      'Antes de Grav, cuenta Suzu, Lamp, Matrix, Beat y movilidad rival.',
    ],
    compositions: [
      { title: 'Brawl con Zarya', body: 'Reaper, Mei, Cassidy o Symmetra con supports como Lucio, Kiriko o Baptiste. La idea es avanzar juntos y castigar cuando el rival dispara burbujas.' },
      { title: 'Rush con burbuja de engage', body: 'Reinhardt, Doomfist o Genji pueden recibir burbuja para entrar más profundo y forzar recursos sin morir instantáneo.' },
      { title: 'Anti-dive', body: 'Zarya protege supports o DPS vulnerables cuando el rival entra. Funciona si no gastas burbujas antes del dive real.' },
    ],
    vodReview: [
      'Revisa cada burbuja: ¿negó daño real o el rival simplemente esperó?',
      'Marca cuándo llegaste a energía alta y si conservabas vida/cobertura.',
      'Comprueba si tus burbujas ayudaron a un aliado a crear ventaja.',
      'Mira tus Graviton: ¿había follow-up y defensivos rivales contados?',
      'Revisa tus muertes en campo abierto. Zarya necesita esquinas más de lo que parece.',
    ],
    checklist: [
      'Tengo cobertura antes de gastar burbujas.',
      'Sé qué engage o burst quiero negar.',
      'No persigo sin recursos.',
      'Uso burbuja aliada para crear ventaja, no por rutina.',
      'Grav tiene follow-up real.',
      'Si el rival juega vertical, no fuerzo el mismo plan.',
    ],
    faqs: [
      { question: '¿Zarya es buena para ranked?', answer: 'Sí, sobre todo si el rival dispara burbujas o tu equipo puede pelear junto. En mapas abiertos o contra mucha verticalidad puede sentirse más limitada.' },
      { question: '¿Cómo cargo energía con Zarya?', answer: 'No busques energía por ego. Cárgala negando burst real, protegiendo engages y usando cobertura para no gastar burbujas antes de tiempo.' },
      { question: '¿Cuál es el error más común con Zarya?', answer: 'Gastar burbujas demasiado pronto y luego entrar sin recursos. La pelea importante empieza cuando el rival se compromete, no cuando cruzas main.' },
      { question: '¿Cuándo uso Graviton Surge?', answer: 'Cuando tu equipo puede disparar, el rival no tiene las respuestas clave y la pelea aún es ganable. No la tires solo porque está cargada.' },
      { question: '¿Quién counterea a Zarya?', answer: 'Héroes de rango, verticalidad y kiteo como Widowmaker, Hanzo, Pharah, Echo o D.Va pueden reducir mucho su ventana si juegan con paciencia.' },
    ],
    links: [
      { href: '/counters/zarya', label: 'Counters de Zarya' },
      { href: '/team-comps/zarya', label: 'Composiciones con Zarya' },
      { href: '/roles/tank', label: 'Guías de Tank' },
      { href: '/heroes/dva', label: 'D.Va' },
      { href: '/heroes/reinhardt', label: 'Reinhardt' },
      { href: '/heroes/winston', label: 'Winston' },
      ...
      { href: '/experts', label: 'Revisar mi Zarya con un experto' },
    ],
  },
}
