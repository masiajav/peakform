...
const ZARYA_COUNTER: CounterPillar = {
  ...
  h1: 'Counter Zarya en Overwatch: picks, burbujas y castigo',
  intro: [
    'Zarya gana partidas cuando tu equipo dispara burbujas por reflejo, le regala energía y después intenta pelearle de cerca como si siguiera siendo débil. Jugar bien el matchup no consiste en ignorarla siempre ni en quemarla siempre: consiste en leer cuántas burbujas le quedan, cuánto daño puede devolver y si su equipo puede acompañar su avance.',
...
const TRACER_COUNTER: CounterPillar = {
  ...
  h1: 'Counter Tracer en Overwatch: forzar Recall y proteger backline',
  intro: [
    'Tracer castiga equipos que miran tarde, gastan cooldowns por ansiedad y dejan supports solos. La respuesta no es perseguirla por todo el mapa; es quitarle duelos limpios, forzar Recall antes de que consiga valor y convertir sus rutas en información para tu equipo.',
...
const DOMINA_COUNTER: CounterPillar = {
  ...
  h1: 'Counter Domina en Overwatch: picks, ángulos y presión frontal',
  intro: [
