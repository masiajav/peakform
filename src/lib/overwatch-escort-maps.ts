...
export const ESCORT_MAP_PILLARS: MapPillar[] = [
  {
    ...
    phases: [
      ...
      },
      {
        ...
        vodReview: 'Separa el primer entrada de cada último intento. Anota quién tocó, quién podía ayudarlo y cuántas definitivas se gastaron cuando la pelea ya estaba decidida.',
      },
    ],
    attackPlan: [
