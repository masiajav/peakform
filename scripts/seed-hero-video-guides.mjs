...
const rows = tuples.map((tuple) => {
  ...
  const body = [
    `## Qué ver antes de jugar ${hero_name}`,
    "",
    `- Identidad del héroe: qué tipo de pelea quiere jugar y qué errores castiga.`,
    `- Prioridades básicas: posicionamiento, cooldowns, objetivo principal y cuándo retirarte.`,
    `- Señales para revisar tus partidas: muertes tempranas, recursos gastados sin ventana y peleas donde no convertiste ventaja.`,
    "",
    "## Cómo usar esta guía",
    "",
  ...
  return {
    title: `${hero_name}: guía en vídeo para empezar mejor`,
    slug: guide_slug,
    body,
    category: "Video guía",
    published: true,
    excerpt: video_summary,
    seo_title: `Guía en vídeo de ${hero_name} en Overwatch`,
    seo_description: `Guía en vídeo de ${hero_name} en Overwatch con resumen rápido, puntos clave y nota para 6v6.`,
    author: video_channel ?? "Replaid Lab",
    hero: hero_slug,
    role,
    map: null,
    tags: [hero_slug, role, "video", "youtube", "6v6"],
    content_type: "guide",
